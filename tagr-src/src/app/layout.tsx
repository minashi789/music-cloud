...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/tags/icons/icon-192x192.png', sizes: '192x192', type: 'image/png' },
      { url: '/tags/icons/icon-512x512.png', sizes: '512x512', type: 'image/png' },
    ],
    apple: [
      { url: '/tags/icons/apple-touch-icon.png', sizes: '180x180', type: 'image/png' },
    ],
  },
}
